...
namespace Core.Unity.Singletons.Editor {
    /// <summary>
    ...
    public class ScriptableSingletonUtility {
        ...
        public static bool IsTypeScriptableSingleton(Type type) {
            ...
            bool isScriptableSingletonInheritor = isGenericBaseType &&
                                                  type.BaseType.GetGenericTypeDefinition() == typeof(Krugames.Core.Unity.Singletons.ScriptableSingleton<>).GetGenericTypeDefinition();
