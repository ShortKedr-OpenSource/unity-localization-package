using Krugames.LocalizationSystem.Unity.Singletons.Editor;
using Krugames.LocalizationSystem.Unity.Singletons.Editor.SingletonManager.Elements;
using UnityEditor;
using UnityEditor.UIElements;
using UnityEngine;
using UnityEngine.UIElements;
using Toolbar = Krugames.LocalizationSystem.Unity.Singletons.Editor.SingletonManager.Elements.Toolbar;

namespace Krugames.LocalizationSystem.Unity.Singletons.Editor.SingletonManager {
    public class SingletonManagerEditor : EditorWindow {
        ...
        private Elements.Toolbar _toolbar;
        ...
        private void CreateGUI() {
            ...
            root.Add(_toolbar = new Elements.Toolbar());
